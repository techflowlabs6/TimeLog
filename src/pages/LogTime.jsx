...
export default function LogTime() {
  ...
  return (
    <div className="max-w-xl mx-auto space-y-4 sm:space-y-6 min-w-0 max-w-full overflow-hidden px-1 sm:px-0">
      ...
      <div className="p-[1.5px] rounded-3xl bg-gradient-to-br from-indigo-500/40 via-purple-500/25 to-pink-500/40 shadow-[0_0_24px_rgba(99,102,241,0.15)] min-w-0 max-w-full box-border">
        <form onSubmit={handleSubmit} className="card p-4 sm:p-7 flex flex-col gap-4 sm:gap-5 min-w-0 max-w-full overflow-hidden bg-base-900/95 backdrop-blur-xl rounded-[22px] border-0 box-border">
          {/* Project Selector */}
