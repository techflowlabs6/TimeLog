...
export default function LogTime() {
  ...
  return (
    <div className="max-w-xl mx-auto space-y-4 sm:space-y-6 min-w-0 px-1 sm:px-0">
      <div>
      ...
      <form onSubmit={handleSubmit} className="card p-4 sm:p-7 flex flex-col gap-4 sm:gap-5 min-w-0 shadow-lg">
        {/* Project Selector */}
        <div className="w-full min-w-0">
          ...
          <div className="relative w-full">
            ...
            <select
              ...
              required
              className="w-full box-border bg-base-850 border border-base-700 hover:border-base-600 focus:border-accent rounded-xl pl-9 pr-8 py-2.5 text-xs sm:text-sm font-semibold text-base-100 outline-none transition-colors appearance-none cursor-pointer shadow-xs"
            >
              {projects.map((p) => (
        ...
        <div className="w-full min-w-0">
          ...
          <div className="relative w-full">
            ...
            <input
              ...
              required
              className="w-full box-border bg-base-850 border border-base-700 hover:border-base-600 focus:border-accent rounded-xl pl-9 pr-3 py-2.5 text-xs sm:text-sm font-semibold text-base-100 outline-none transition-colors shadow-xs cursor-pointer"
            />
          </div>
        </div>
        ...
        <div className="w-full min-w-0">
          ...
          <div className="grid grid-cols-3 p-1 bg-base-850 rounded-xl border border-base-700 gap-1 w-full box-border">
            <button
              type="button"
        ...
        {mode === 'timer' && (
          <div className="w-full p-4 sm:p-5 rounded-2xl bg-base-900 border border-accent/30 flex flex-col items-center justify-center gap-3 shadow-inner box-border">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full min-w-0">
            <div className="w-full min-w-0">
              ...
              <input
                ...
                onClick={(e) => e.target.showPicker?.()}
                className="w-full box-border bg-base-850 border border-base-700 hover:border-base-600 focus:border-accent rounded-xl px-3 py-2.5 text-xs sm:text-sm font-semibold text-base-100 outline-none transition-colors shadow-xs cursor-pointer"
              />
            </div>
            <div className="w-full min-w-0">
              <label className="flex items-center gap-1.5 text-[11px] font-mono font-bold tracking-wider uppercase text-slate-500 dark:text-slate-400 mb-1.5">
        ...
        {mode === 'manual' && (
          <div className="w-full min-w-0">
            ...
            <input
              ...
              placeholder="e.g. 1.5"
              required
              className="w-full box-border bg-base-850 border border-base-700 hover:border-base-600 focus:border-accent rounded-xl px-3 py-2.5 text-xs sm:text-sm font-semibold text-base-100 outline-none transition-colors shadow-xs"
            />
          </div>
        )}

        {/* Duration Preview Pill */}
        <div className="w-full bg-base-850/80 border border-base-800 rounded-xl p-3 flex items-center justify-between text-xs text-base-300 box-border">
        ...
        <div className="w-full min-w-0">
          ...
          <textarea
            ...
            className="w-full box-border bg-base-850 border border-base-700 rounded-xl px-3 py-2.5 text-xs sm:text-sm text-base-100 placeholder-base-400 focus:border-accent outline-none resize-none"
          />
        </div>
        ...
        <button
          ...
          className="w-full bg-accent hover:bg-accent-soft transition-all text-base-950 font-bold text-xs sm:text-sm py-3 rounded-xl disabled:opacity-50 mt-1 shadow-md active:scale-95"
        >
